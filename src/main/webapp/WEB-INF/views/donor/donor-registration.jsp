...
<head>
    ...
    <title>Application Submitted | eDonorNet</title>
...
<section class="py-5" style="background-color: rgba(229, 57, 53, 0.05);">
    <div class="container text-center">
        ...
        <h1 class="display-5 fw-bold">Application Submitted</h1>
        <p class="lead text-muted">Thank you! Your application and medical details are now pending review.</p>
    </div>
</section>
            ...
            <div class="col-lg-10">
                <div class="card shadow-sm border-0">
                    <div class="card-body p-4 p-md-5">
                        <h2 class="text-center mb-4">Your Submission Status</h2>
                        ...
                        <div class="alert alert-secondary" role="alert">
                            ...
                            <p>Your application and medical history are now being verified by our medical team. This process usually takes 1-2 business days.</p>
                            <hr>
                            <p class="mb-0">You will be notified via email and your dashboard will be updated as soon as your profile is approved.</p>
                        </div>
