...
<head>
    ...
    <title>Application Status | eDonorNet</title>
    ...
    <style>
        ...
        .timeline::before {
            ...
            width: 90%; /* End before the last icon */
            height: 4px;
        ...
        .timeline-step.active .timeline-icon {
            background-color: var(--primary); /* Theme Red */
        }
        .timeline-step p {
            margin-top: 10px;
            font-weight: 500;
...
<section class="py-5" style="background-color: rgba(229, 57, 53, 0.05);">
    <div class="container text-center">
        ...
        <p class="lead text-muted">Here are the details of your donor registration application.</p>
    </div>
</section>
            ...
            <div class="col-lg-10">
                <div class="card shadow-sm border-0">
                    <div class="card-body p-4 p-md-5">
                        <h2 class="text-center mb-4">Your Application Details</h2>

                        <div class="row mb-4 text-center text-md-start">
                            <div class="col-md-4">
                                <p class="text-muted mb-0">Application ID</p>
                                <p class="fw-bold">DNR-${donor.id}</p>
                            </div>
                            <div class="col-md-4">
                                <p class="text-muted mb-0">Submitted On</p>
                                <p class="fw-bold">${donor.date}</p>
                            </div>
                            <div class="col-md-4">
                                <p class="text-muted mb-0">Current Status</p>
                                <p class="fw-bold fs-5">
                                    <span class="badge bg-warning text-dark">${donor.status}</span>
                                </p>
                            </div>
                        </div>
                        ...
                        <h4 class="mt-5">Status Details</h4>
                        <div class="alert alert-secondary" role="alert">
                            <h5 class="alert-heading">Your Application is Under Review</h5>
                            <p>Your application and medical history are currently being verified by our medical team. This process usually takes 1-2 business days.</p>
                            <hr>
                            <p class="mb-0">No further action is needed from you at this time. We will notify you via email as soon as your profile is approved and active.</p>
                        </div>
